...
static void size_change(GtkAdjustment * adj, gpointer window) {
	...
	parameter_update((PisimAppWindow *) window);
}

static void multip_change(GtkAdjustment * adj, gpointer window) {
	long a = 1 + 4 * gtk_adjustment_get_value(adj);
	char value[32];
	GtkWidget * multip_value = ((PisimAppWindow *) window)->multip_value;
	data_t * context = &((PisimAppWindow *) window)->context;
...
static void aditiv_change(GtkAdjustment * adj, gpointer window) {
	...
	char value[32];
	GtkWidget * aditiv_value = ((PisimAppWindow *) window)->aditiv_value;
	data_t * context = &((PisimAppWindow *) window)->context;
...
static void modulo_change(GtkAdjustment * adj, gpointer window) {
	...
	char value[32];
	GtkWidget * modulo_value = ((PisimAppWindow *) window)->modulo_value;
	data_t * context = &((PisimAppWindow *) window)->context;
